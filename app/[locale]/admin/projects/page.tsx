          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm text-amber-700">
                <strong className="font-semibold">Önemli:</strong> Değişiklikler sadece bu tarayıcıda saklanır. Başka cihaz/tarayıcıdan erişilemez. 
                Kalıcı depolama için veritabanı entegrasyonu gereklidir. <a href="/ADMIN_PANEL.md" target="_blank" className="underline font-medium hover:text-amber-800">Detaylı Bilgi</a>
              </p>
            </div>
          </div>
        </div>
